<template>
  <div>
    <div>
      ...
      <!-- モーダルポップアップの要素を作成 -->
      <div
        id="room-setting-overlay"
        v-show="ShowContentRoomSetting"
        v-on:click="roomSettingPopDown"
      >
          ...
          <div class="container">
            ...
            <div class="right-column">
              ...
              <ImageUpload
                ...
                v-on:image-upload-emit="uploadImage1($event)"
              />
          ...
          <div class="container">
            ...
            <div class="right-column">
              ...
              <ImageUpload
                ...
                v-on:image-upload-emit="uploadImage2($event)"
              />
      ...
      <div
        id="room-add-complete-overlay"
        v-show="ShowContentRoomAddComp"
        v-on:click="roomAddCompPopDown"
      >
...
#room-setting-overlay,
#room-add-complete-overlay {
  /* 要素を重ねた時の順番 */
  z-index: 1;
...
#room-setting-content,
#room-add-complete-content {
  z-index: 2;
  width: 65%;
  max-height: 650px;
  padding: 1em;
