<template>
  <div>
    <div>
        <input type="text" @keypress.enter="searchPokemon" v-model="SearchName" placeholder="ポケモン名を入力">
...
export default {
  ...
  methods: {
    ...
    getPokemonApi (searchname) {
        if (searchname !== ""){
            // 検索ワードが入力されたときにコール
            let apisearchname = this.convertPokemonName('en', searchname).toLowerCase()
            this.axios
